...
type PixServiceClient interface {
	...
	Fin(ctx context.Context, in *PixKey, opts ...grpc.CallOption) (*PixKeyInfo, error)
}
...
func (c *pixServiceClient) RegisterPixKey(ctx context.Context, in *PixKeyRegistration, opts ...grpc.CallOption) (*PixKeyCreatedResult, error) {
	...
	err := c.cc.Invoke(ctx, "/github.com.wwwillian.codepix.PixService/RegisterPixKey", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *pixServiceClient) Fin(ctx context.Context, in *PixKey, opts ...grpc.CallOption) (*PixKeyInfo, error) {
	out := new(PixKeyInfo)
	err := c.cc.Invoke(ctx, "/github.com.wwwillian.codepix.PixService/Fin", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type PixServiceServer interface {
	...
	Fin(context.Context, *PixKey) (*PixKeyInfo, error)
...
func (UnimplementedPixServiceServer) Fin(context.Context, *PixKey) (*PixKeyInfo, error) {
...
func _PixService_RegisterPixKey_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/github.com.wwwillian.codepix.PixService/RegisterPixKey",
	}
...
func _PixService_Fin_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(PixKey)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PixServiceServer).Fin(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/github.com.wwwillian.codepix.PixService/Fin",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PixServiceServer).Fin(ctx, req.(*PixKey))
	}
	return interceptor(ctx, in, info, handler)
}
...
var PixService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "github.com.wwwillian.codepix.PixService",
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "Fin",
			Handler:    _PixService_Fin_Handler,
		},
	},
